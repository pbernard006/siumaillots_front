    ...
    >
      ...
      <div className="carousel-inner relative w-full overflow-hidden">
        <div className="carousel-item active relative float-left w-full">
          <Image src={carousel1} alt="Img carousel" className="block w-full" />
          <div className="carousel-caption hidden md:block absolute text-center">
            <h5 className="text-xl">Retrouvez les maillots des bleus...</h5>
          </div>
        </div>
        <div className="carousel-item relative float-left w-full">
          <Image src={carousel2} alt="Img carousel" className="block w-full" />
          <div className="carousel-caption hidden md:block absolute text-center">
            <h5 className="text-xl">de votre joueur favori...</h5>
          </div>
        </div>
        <div className="carousel-item relative float-left w-full">
          <Image src={carousel3} alt="Img carousel" className="block w-full" />
          <div className="carousel-caption hidden md:block absolute text-center">
